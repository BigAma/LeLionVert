...
import QRArtemesia from '../../assets/QRcodeArtemisia.png'
import QRCorossol from '../../assets/QRcodeCorossol.png'
import QRMoringa from '../../assets/QRcodeMoringa.png'
import QRBissap from '../../assets/QRcodeBissap.png'
...
const Description = (props) => {
  ...
  const descriptionAG = [
    ...
    {titre: 'En Savoir Plus', dcp:<img src={QRArtemesia} width='250px' height='250px' alt='Artemisia Annua'></img>}
  ]
  ...
  const descriptionCI = [
    ...
    {titre: 'En Savoir Plus', dcp:<img src={QRCorossol} width='250px' height='250px' alt='Corossol'></img>}
  ]

  const descriptionMG = [
    {titre:'Moringa Gellule', dcp:"Les feuilles de Moringa Oleifera sont d'une grande valeur nutritives, elles sont notamment riche en vitamines (B1, B2, B3, B5, B6, B8, A, C, E, K, ...) en minéraux (calcium, magnesium, potassium, zinc ...), en Oligo-élements essentiels (Fer, Cuivre, Soufre) ainsi qu'en Protéines bio disponibles."},
    ...
    {titre: 'En Savoir Plus', dcp:<img src={QRMoringa} width='250px' height='250px' alt='Moringa'></img>}
  ]

  const descriptionMI = [
    {titre:'Moringa Infusette', dcp:"Les feuilles de Moringa Oleifera sont d'une grande valeur nutritives, elles sont notamment riche en vitamines (B1, B2, B3, B5, B6, B8, A, C, E, K, ...) en minéraux (calcium, magnesium, potassium, zinc ...), en Oligo-élements essentiels (Fer, Cuivre, Soufre) ainsi qu'en Protéines bio disponibles."},
    {titre: 'Proprietes et Bienfaits', dcp:"Les feuilles de moringa pourraient guérir plus de 300 maladies. En phytothérapie la poudre de feuilles de moringa est indiquée pour stimuler le système immunitaire, réduire la fatigue, abaisser la pression artérielle, ameliorer la digestion et le transit, renforcer les capacités cognitives, lutter contre la malnutrition, combler les carences nutritives, aider à atteindre et à maintenir un bon taux de cholestérol, combat l'anémie, la perte d'appétit ..."},
    {titre: 'En Savoir Plus', dcp:<img src={QRMoringa} width='250px' height='250px' alt='Moringa'></img>}
  ]

  const descriptions = [ descriptionBi, descriptionAI, descriptionAG, descriptionCI, descriptionMG, descriptionMI]
  ...
  return (
    <div className='description'>
      ...
      {true && console.log(descriptions[props.produit][2].dcp)}

      <div className='full-text-descp'>
        <h6>{descriptions[props.produit][descp].titre}</h6>
        <br />
        {descriptions[props.produit][descp].dcp}
      </div>
